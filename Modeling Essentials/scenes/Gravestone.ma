...
//Name: Gravestone.ma
//Last modified: Wed, Jul 31, 2024 10:48:24 PM
//Codeset: 1252
requires maya "2025";
...
fileInfo "UUID" "4939B595-49BC-91A8-815C-AE9DAACCA29C";
createNode transform -s -n "persp";
	rename -uid "5FD80AFB-DE45-74FB-13E4-1AA0F0ABADAB";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.6823347178892503 2.8312810101669279 7.3399146884448809 ;
	setAttr ".r" -type "double3" 167.48418075940424 -153.48451212874608 -179.9999999999973 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 8.3872439711600286;
...
createNode transform -n "directionalLight2";
	...
	setAttr ".r" -type "double3" -172.79277310677972 0 0 ;
	setAttr ".s" -type "double3" 12.44727086409585 12.44727086409585 12.44727086409585 ;
...
createNode transform -n "locator1";
	rename -uid "3260C762-47D2-155D-FA88-FBBDF0291005";
createNode locator -n "locatorShape1" -p "locator1";
	rename -uid "F340F38F-4453-450A-6244-9DB4C3E1D1BE";
	setAttr -k off ".v";
createNode transform -n "Main_Camera" -p "locator1";
	rename -uid "933C4198-466B-8AC2-596B-56A604342C22";
	setAttr ".t" -type "double3" -3.2919158208478927 1.785487125415528 5.2939576250408011 ;
	setAttr ".r" -type "double3" -8.3999999999999986 -31.200000000000045 0 ;
createNode camera -n "Main_CameraShape" -p "Main_Camera";
	rename -uid "06A4D9FD-4215-126D-6296-7CBBC2C37111";
	setAttr -k off ".v";
	setAttr ".cap" -type "double2" 1.41732 0.94488 ;
	setAttr ".ff" 0;
	setAttr ".ovr" 1.3;
	setAttr ".coi" 8.227972740983251;
	setAttr ".ow" 30;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "EBFD31B0-48AE-0858-10DA-FC93014CEAC5";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "99A55413-4040-E8E0-3A79-99A10CFBFE93";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "637B25E1-4714-1A64-E6A5-D2A3298038A5";
createNode displayLayerManager -n "layerManager";
	rename -uid "1C86C272-46BC-1B05-580F-69BE0B9F76A0";
createNode displayLayer -n "defaultLayer";
	rename -uid "314B9896-2841-8FA0-76A6-36AAC8005BD1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "C77F201D-426A-DF97-6402-5D83F742EED7";
...
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	...
	setAttr ".ARV_options" -type "string" "Test Resolution=100%;Camera=Main_CameraShape;Color Management.Gamma=1;Color Management.Exposure=0;Background.BG=BG Color;Background.Color=0 0 0;Background.Image=;Background.Scale=1  1;Background.Offset=0  0;Background.Apply Color Management=1;Foreground.Enable FG=0;Foreground.Image=;Foreground.Scale=1  1;Foreground.Offset=0  0;Foreground.Apply Color Management=1;";
...
createNode animCurveTA -n "locator1_rotateX";
	rename -uid "0E6E2A34-4B6E-4238-711C-4C8FEA1FA423";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
...
createNode animCurveTA -n "locator1_rotateY";
	rename -uid "1945C0B0-44B4-FA7B-733A-A3A6353A6C01";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 0 49 360;
	setAttr -s 2 ".kit[1]"  1;
	setAttr -s 2 ".kot[1]"  1;
	setAttr -s 2 ".kix[1]"  0.29756033688962363;
	setAttr -s 2 ".kiy[1]"  0.9547030145077231;
	setAttr -s 2 ".kox[1]"  1;
	setAttr -s 2 ".koy[1]"  0;
createNode animCurveTA -n "locator1_rotateZ";
	rename -uid "94D83648-4C40-F2A5-C014-5FBE1B95B15A";
	setAttr ".tan" 2;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 0 49 0;
	setAttr -s 2 ".kit[1]"  1;
...
select -ne :defaultRenderGlobals;
	...
	setAttr ".ef" 48;
	setAttr ".pff" yes;
	setAttr ".ifp" -type "string" "Render Passes/<Scene>/<Version>/<RenderPass>/<RenderPass>";
